...
[assembly: ExportRenderer (typeof(ImageButton), typeof(CocoMapsAndroid.ImageButtonRenderer))]
namespace CocoMapsAndroid
{
	...
	public class ImageButtonRenderer : ButtonRenderer
	{
		...
		ImageButton ImageButton { get { return (ImageButton)Element; } }
		...
		void SetImageSource (Android.Widget.Button targetButton, ImageButton model)
		{
		...
		Drawable GetScaleDrawableFromResourceId (int resId, int width, int height)
		{
