...
namespace CocoMaps.Shared
{
	public class Bookmark : ContentPage
	{
		...
		readonly BookmarksRepository bookmarksRepository = new BookmarksRepository ();
		...
		async void HandleItemSelected (object sender, SelectedItemChangedEventArgs e)
		{
			if (e.SelectedItem != null) {
				...
				var BookmarksClickedInput = await DisplayActionSheet (eBookmark.bName, "Cancel", null, "Get Directions", "Delete Bookmark", "Delete All Bookmarks");
