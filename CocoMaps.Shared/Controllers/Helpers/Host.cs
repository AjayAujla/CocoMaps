...
// Code taken from http://www.dreamincode.net/forums/topic/71263-using-the-ping-class-in-c%23/
...
namespace CocoMaps.Shared
{
	...
	public static class Host
	{
		...
		/// </summary>
		/// <param name="address">the host we need to ping</param>
		/// <returns></returns>
		...
		/// <returns></returns>
		static IPAddress GetIpFromHost (ref string host)
		{
